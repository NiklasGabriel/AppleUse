...
<body>
    ...
    <div class="content">
        <h1>Inhalt</h1>
        <ol>
            <li><a href="article.php?path=die_basics.php">Die Basics</a></li>
            <ol>
                <li><a href="article.php?path=die_basics/erster_start.php">Erster Start</a></li>
                <li><a href="article.php?path=die_basics/die_macos_oberfläche.php">Die macOS Oberfläche</a></li>
